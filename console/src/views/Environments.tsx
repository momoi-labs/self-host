...
export function Environments({
  ...
  const place = running ? position(operation.action, operation.step) : null;
              ...
              <>
                ...
                {running ? (
                  <StatusBadge tone="neutral">
                    {NOUNS[operation.action] ?? operation.action}
                    {place ? ` ${place.at} of ${place.of}` : " running"}
                  </StatusBadge>
                ) : null}
              </>
            }
    ...
    <form className="stack environment-editor" onSubmit={onSubmit}>
      ...
      {!existing ? (
        ...
        <SaveBar
          ...
          message={
            <>
              <b>Unsaved changes.</b> The machine keeps running as it is until you save and apply.
            </>
          }
          actions={
            <>
        ...
        <SaveBar
          ...
          message={
            <>
              <b>The last run failed</b> at {failedAt}.{" "}
              {pendingApply
        ...
        <SaveBar
          ...
          message={
            <>
              <b>Saved, not applied.</b> The machine still runs the previous configuration.
            </>
          }
          actions={
        ...
        <SaveBar message="Saved and applied." />
      )}
    </form>
  );
}
